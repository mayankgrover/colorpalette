...
public static class NumericConstants
{
    ...
    public static int FREE_GIFT_CYCLE_SECONDS = 360;
    ...
    public static TimeSpan PN_DAY_2 = new TimeSpan(days: 0, hours: 0, minutes: 0, seconds: 10);
    public static TimeSpan PN_DAY_3 = new TimeSpan(days: 0, hours: 0, minutes: 0, seconds: 20);
    public static TimeSpan PN_DAY_5 = new TimeSpan(days: 0, hours: 0, minutes: 0, seconds: 30);
}
